...
print("Test 1: test_db_connector_1 - remote")
try:
...
try:
    print("Create DB Connector Instance")
    test_db_connector_2 = InfluxDBConnector(database=database)
    print("List databases")
    print(test_db_connector_2.list_databases())
    print("Create test database")
    test_db_connector_2.create_database(database)
    print("List databases")
    print(test_db_connector_2.list_databases())

    print("Write DataFrame")
    test_db_connector_2.write_points(df, 'adrian_test_db', protocol=protocol)
    print("Read DataFrame")
    result = test_db_connector_2.query(query)
    print("Result: {0}".format(result))

    print("Delete test database")
    test_db_connector_2.delete_database(database)
    print("List databases")
    print(test_db_connector_2.list_databases())
    print("Test: Passed\n")
except ConnectionError as error:
